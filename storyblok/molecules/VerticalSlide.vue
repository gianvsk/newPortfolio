...
<template>
  ...
  >
    <div class="w-full h-[90dvh] xl:h-[95%] 2xl:h-full xl:pt-5 overflow-hidden">
      <div
        class="gap-4 px-4 w-full h-full flex flex-col justify-start md:flex-row md:portrait:flex-col md:portrait:gap-8 md:px-5 md:gap-6 md:gap-y-6 lg:gap-x-10 md:pb-6 lg:px-10 xl:px-[101.6px]"
        :class="{
